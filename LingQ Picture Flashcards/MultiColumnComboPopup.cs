...
namespace LingQ_Picture_Flashcards
{
	...
	public class MultiColumnComboPopup : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.lstvMyView.Size = new System.Drawing.Size(292, 500);
		...
		private void InitializeGridProperties() {
			...
			for(int i=0;i<mCols;i++) {
				lstvMyView.Columns.Add(columnsToDisplay[i], columnsToDisplay[i].Length*11, HorizontalAlignment.Left);
				if(i==0)
				{
					lstvMyView.Columns[0].Width = -1;
				}
		...
		public void AddItems(string[][] ItemValues) {
			if(ItemValues.Length > 0) {
				...
				//this.Height = lstvMyView.Items.Count*10;
				//lstvMyView.Height = lstvMyView.Items.Count * 10;
			}
			else {
